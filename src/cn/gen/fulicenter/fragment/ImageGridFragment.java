...
import cn.gen.fulicenter.BuildConfig;
import cn.gen.fulicenter.activity.RecorderVideoActivity;
import cn.gen.fulicenter.domain.VideoEntity;
import cn.gen.fulicenter.video.util.ImageCache;
import cn.gen.fulicenter.video.util.ImageResizer;
import cn.gen.fulicenter.video.util.Utils;
import cn.gen.fulicenter.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				cn.gen.fulicenter.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				cn.gen.fulicenter.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(cn.gen.fulicenter.R.drawable.empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(cn.gen.fulicenter.R.layout.image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(cn.gen.fulicenter.R.id.gridView);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(cn.gen.fulicenter.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(cn.gen.fulicenter.R.layout.choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(cn.gen.fulicenter.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(cn.gen.fulicenter.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(cn.gen.fulicenter.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(cn.gen.fulicenter.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(cn.gen.fulicenter.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(cn.gen.fulicenter.R.drawable.actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(cn.gen.fulicenter.R.drawable.empty_photo);
