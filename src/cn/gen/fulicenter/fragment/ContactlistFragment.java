...
import cn.gen.fulicenter.adapter.ContactAdapter;
...
import cn.gen.fulicenter.widget.Sidebar;
...
public class ContactlistFragment extends Fragment {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (success) {
                                ...
                                String s1 = getResources().getString(cn.gen.fulicenter.R.string.get_failed_please_check);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(cn.gen.fulicenter.R.layout.fragment_contact_list, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listView = (ListView) getView().findViewById(cn.gen.fulicenter.R.id.list);
        sidebar = (Sidebar) getView().findViewById(cn.gen.fulicenter.R.id.sidebar);
        ...
        //搜索框
        query = (EditText) getView().findViewById(cn.gen.fulicenter.R.id.query);
        query.setHint(cn.gen.fulicenter.R.string.search);
        clearSearch = (ImageButton) getView().findViewById(cn.gen.fulicenter.R.id.search_clear);
        ...
        // 设置adapter
        adapter = new ContactAdapter(getActivity(), cn.gen.fulicenter.R.layout.row_contact, mContactList);
        ...
        ImageView addContactView = (ImageView) getView().findViewById(cn.gen.fulicenter.R.id.iv_new_contact);
        // 进入添加好友页
        ...
        progressBar = (View) getView().findViewById(cn.gen.fulicenter.R.id.progress_bar);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (item.getItemId() == cn.gen.fulicenter.R.id.delete_contact) {
            try {
                // 删除此联系人
            ...
            return true;
        } else if (item.getItemId() == cn.gen.fulicenter.R.id.add_to_blacklist) {
    ...
    public void deleteContact(final Contact tobeDeleteEMUser) {
        String st1 = getResources().getString(cn.gen.fulicenter.R.string.deleting);
        final String st2 = getResources().getString(cn.gen.fulicenter.R.string.Delete_failed);
        ...
        try {
            ...
            ((MainActivity) getActivity()).executeRequest(new GsonRequest<Boolean>(path,
                    Boolean.class, responseDeleContactListener(tobeDeleteEMUser),
    ...
    private Response.Listener<Boolean> responseDeleContactListener(final Contact tobeDeleteEMUser) {
    ...
    private void moveToBlacklist(final String username) {
        final ProgressDialog pd = new ProgressDialog(getActivity());
        String st1 = getResources().getString(cn.gen.fulicenter.R.string.Is_moved_into_blacklist);
        final String st2 = getResources().getString(cn.gen.fulicenter.R.string.Move_into_blacklist_success);
        final String st3 = getResources().getString(cn.gen.fulicenter.R.string.Move_into_blacklist_failure);
        pd.setMessage(st1);
        pd.setCanceledOnTouchOutside(false);
        pd.show();
        new Thread(new Runnable() {
    ...
    private void getContactList() {
        ...
        Log.i("ContactAdapter", "++++++++++++++++" + String.valueOf(mContactList.indexOf(groupUser)));
        if (mContactList.indexOf(groupUser) == 0) {
            mContactList.add(0, groupUser);
        }

        Log.i("ContactAdapter", "******************" + String.valueOf(mContactList.size()));
...
//		 //把"申请与通知"添加到首位
//        if (mContactList.get(Constant.NEW_FRIENDS_USERNAME) != null)
//            mContactList.add(0, contactList.get(Constant.NEW_FRIENDS_USERNAME));
