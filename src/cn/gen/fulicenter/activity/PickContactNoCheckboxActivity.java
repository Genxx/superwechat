...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.gen.fulicenter.R.layout.activity_pick_contact_no_checkbox);
		listView = (ListView) findViewById(cn.gen.fulicenter.R.id.list);
		sidebar = (Sidebar) findViewById(cn.gen.fulicenter.R.id.sidebar);
		sidebar.setListView(listView);
		contactList = new ArrayList<Contact>();
		// 获取设置contactlist
		getContactList();
		// 设置adapter
		contactAdapter = new ContactAdapter(this, cn.gen.fulicenter.R.layout.row_contact, contactList);
