...
import cn.gen.fulicenter.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.gen.fulicenter.R.layout.alert_dialog);
		mTextView = (TextView) findViewById(cn.gen.fulicenter.R.id.title);
		mButton = (Button) findViewById(cn.gen.fulicenter.R.id.btn_cancel);
		imageView = (ImageView) findViewById(cn.gen.fulicenter.R.id.image);
		editText = (EditText) findViewById(cn.gen.fulicenter.R.id.edit);
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(cn.gen.fulicenter.R.id.alert_message)).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(cn.gen.fulicenter.R.id.alert_message)).setVisibility(View.GONE);
