...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(cn.gen.fulicenter.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(cn.gen.fulicenter.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(cn.gen.fulicenter.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(cn.gen.fulicenter.R.id.tv_nickname_description);
