...
public class AddContactActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.gen.fulicenter.R.layout.activity_add_contact);
        mTextView = (TextView) findViewById(cn.gen.fulicenter.R.id.add_list_friends);

        editText = (EditText) findViewById(cn.gen.fulicenter.R.id.edit_note);
        String strAdd = getResources().getString(cn.gen.fulicenter.R.string.add_friend);
        mTextView.setText(strAdd);
        String strUserName = getResources().getString(cn.gen.fulicenter.R.string.user_name);
        editText.setHint(strUserName);
        searchedUserLayout = (LinearLayout) findViewById(cn.gen.fulicenter.R.id.ll_user);
        nameText = (TextView) findViewById(cn.gen.fulicenter.R.id.name);
        searchBtn = (Button) findViewById(cn.gen.fulicenter.R.id.search);
        avatar = (NetworkImageView) findViewById(cn.gen.fulicenter.R.id.avatar);
    ...
    public void searchContact(View v) {
        ...
        if (TextUtils.isEmpty(name)) {
            String st = getResources().getString(cn.gen.fulicenter.R.string.Please_enter_a_username);
        ...
        if (FuliCenterApplication.getInstance().getUserName().equals(name.trim())) {
            String str = getString(cn.gen.fulicenter.R.string.not_add_myself);
    ...
    public void addContact(View view) {
        ...
        if (((DemoHXSDKHelper) HXSDKHelper.getInstance()).getContactList().containsKey(nameText.getText().toString())) {
            ...
            String strin = getString(cn.gen.fulicenter.R.string.This_user_is_already_your_friend);
            startActivity(new Intent(this, AlertDialog.class).putExtra("msg", strin));
            return;
        }

        progressDialog = new ProgressDialog(this);
        String stri = getResources().getString(cn.gen.fulicenter.R.string.Is_sending_a_request);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    String s = getResources().getString(cn.gen.fulicenter.R.string.Add_a_friend);
                    EMContactManager.getInstance().addContact(toAddUsername, s);
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            String s1 = getResources().getString(cn.gen.fulicenter.R.string.send_successful);
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            progressDialog.dismiss();
                            String s2 = getResources().getString(cn.gen.fulicenter.R.string.Request_add_buddy_failure);
