 ...
 */
package cn.gen.superwechat.widget;
...
public class Sidebar extends View{
	...
	private void init(){
	    String st = context.getString(cn.gen.superwechat.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(cn.gen.superwechat.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(cn.gen.superwechat.R.drawable.sidebar_background_pressed);
			return true;
		}
