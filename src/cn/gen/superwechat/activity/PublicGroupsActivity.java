...
public class PublicGroupsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchBtn = (Button) findViewById(cn.gen.superwechat.R.id.btn_search);
	...
	private class GroupsAdapter extends ArrayAdapter<EMGroupInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			((TextView) convertView.findViewById(cn.gen.superwechat.R.id.name)).setText(getItem(position).getGroupName());
