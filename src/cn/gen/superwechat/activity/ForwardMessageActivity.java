...
//		if (position != 0) {
			...
			intent.putExtra("msg", getString(cn.gen.superwechat.R.string.confirm_forward_to, selectEMUser.getMContactCname()));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == RESULT_OK) {
			...
			if (selectEMUser == null)
				return;
			// it is single chat
			intent.putExtra("userId", selectEMUser.getMContactCname());
