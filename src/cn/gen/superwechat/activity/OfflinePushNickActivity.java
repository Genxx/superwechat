...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(cn.gen.superwechat.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(cn.gen.superwechat.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(cn.gen.superwechat.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(cn.gen.superwechat.R.id.tv_nickname_description);
